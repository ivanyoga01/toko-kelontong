...
12.  **[SEO](12-SEO_EXPERT.md)** - Keyword research, on-page optimization, content strategy, technical SEO, and performance monitoring to ensure maximum discoverability and alignment with user search intent
13. **[Security Engineer](13-SECURITY_ENGINEER.md)** - Threat modeling, vulnerability assessments, encryption, access controls, and compliance with industry standards
...
11. **SEO**: How will this feature affect search visibility? Are there keyword opportunities, technical implications for indexing, or content changes needed to align with user search intent?
12. **Security Engineer**: What are the potential security risks? How can we mitigate them?
